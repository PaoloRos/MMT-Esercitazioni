...
È qualitativamente evidente come la differenza di fase **non sia costante**, che spiega il ritardo accumulato nel tempo. La ragione di questo fatto potrebbe risiedere in **errori numerici**, come per esempio nella computazione di `fft()` o di `freqresp` relativa alla FdT. Ad ogni modo, è molto contenuto tale ritardo, percui ai fini dell'esercitazione si può accettare il risultato.
